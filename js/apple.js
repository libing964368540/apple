...
var move=function(n,dir){
  ...
  $('.banner').on('mouseover',function(){
    console.log($('.banner .btn'))
      $('.banner .btn').addClass('btn1')
      clearInterval(t)
  })
  $('.banner').on('mouseout',function(){
    $('.banner .btn').removeClass('btn1')
...
$('.footer-1 h3').on('click',function(){
   if($('.footer').outerWidth(true)>768){
      ...
      $(this).find('.jiahao').toggleClass('jiahao1')
  
   })
 
    $('.jiahao').on('click',function(){
      $(this).toggleClass('jiahao1')
